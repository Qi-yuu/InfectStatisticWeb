...
-->
            ...
            <div id="ProLab">
                ...
                <div>
                	<input type="button" id="ipButton" class="Button" value="新增确诊趋势" onClick="changeColor4()"/>
                    <input type="button" id="ipButton" class="Button" value="累计确诊趋势" onClick="changeColor1()"/>
